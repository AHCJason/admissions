...
if (file_exists(dirname(__FILE__) . "/.development")) {
	...
	define('ENGINE_PUBLIC_PATH', '/home/aptitude/sites/ahc/dev/cms2/public');
	define('APP_PATH', dirname(__FILE__));
	define('APP_PROTECTED_PATH', APP_PATH . "/protected");
	define('APP_PUBLIC_PATH', APP_PATH . "/public");
	$ENGINE_URL = "http://ahc-dev.aptitudecare.com/cms2-public";
	$SITE_URL = "http://ahc-dev.aptitudecare.com";
	$SECURE_CDN_URL = $SITE_URL;
	define('DEVELOPMENT', true);
} else {
	define('ENGINE_PROTECTED_PATH', '/home/aptitude/sites/ahc/live/cms2/protected');
	define('ENGINE_PUBLIC_PATH', '/home/aptitude/sites/ahc/live/cms2/public');
	define('APP_PATH', dirname(__FILE__));
	define('APP_PROTECTED_PATH', APP_PATH . "/protected");
	define('APP_PUBLIC_PATH', APP_PATH . "/public");
	$ENGINE_URL = "http://ahc.aptitudecare.com/cms2-public";
	$SITE_URL = "http://ahc.aptitudecare.com";
	$SECURE_CDN_URL = $SITE_URL;
