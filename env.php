...
#		define('SHARED_COMPOSER_LIB', '/home/aptitude/vendor');
		...
		// set urls
		$ENGINE_URL = "https://dev.local.aptitudecare.com/cms2-public";
		$SITE_URL = "https://dev.local.aptitudecare.com/admission/";
		$HOMEHEALTH_URL = "https://dev.local.aptitudecare.com/";
		$SECURE_CDN_URL = $SITE_URL;
		define('DEVELOPMENT', true);
	} else { // this is the remote demo site
		define('APP_NAME', "Remote Dev");
