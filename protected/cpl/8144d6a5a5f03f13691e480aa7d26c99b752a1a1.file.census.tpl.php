<?php /* Smarty version Smarty-3.1.13, created on 2014-04-25 14:45:21
         compiled from "/home/aptitude/dev/app/protected/tpl/facility/census.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2060548391535ac922635392-85449973%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8144d6a5a5f03f13691e480aa7d26c99b752a1a1' => 
    array (
      0 => '/home/aptitude/dev/app/protected/tpl/facility/census.tpl',
      1 => 1398458719,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2060548391535ac922635392-85449973',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_535ac9227a84b2_86528427',
  'variables' => 
  array (
    'facility' => 0,
    'ENGINE_URL' => 0,
...
<?php if ($_valid && !is_callable('content_535ac9227a84b2_86528427')) {function content_535ac9227a84b2_86528427($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/aptitude/dev/cms2/protected/lib/contrib/Smarty-3.1.13/libs/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/home/aptitude/dev/cms2/protected/lib/contrib/Smarty-3.1.13/libs/plugins/function.cycle.php';
...
&export=excel"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['PUBLIC_URL']->value, ENT_QUOTES, 'UTF-8');?>
...
/?page=facility&action=census&facility=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['facility']->value->pubid, ENT_QUOTES, 'UTF-8');?>
&export=pdf" type="_blank"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['PUBLIC_URL']->value, ENT_QUOTES, 'UTF-8');?>
...
"<?php if ($_smarty_tpl->tpl_vars['f']->value->id==$_smarty_tpl->tpl_vars['facility']->value->id){?> selected<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['f']->value->name, ENT_QUOTES, 'UTF-8');?>
	...
	<div style="float: right; margin-bottom: 20px">
		...
		<select id="type">
			...
			<option value="empty"<?php if ($_smarty_tpl->tpl_vars['type']->value=='empty'){?> selected<?php }?>>Just empty rooms</option>
			<option value="scheduled"<?php if ($_smarty_tpl->tpl_vars['type']->value=='scheduled'){?> selected<?php }?>>Just assigned rooms&nbsp;&nbsp;</option>
		</select>
	</div>
</div>
...
:</td>
						<td align="right"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p']->value, ENT_QUOTES, 'UTF-8');?>
</td>
					</tr>
				<?php }?>
			<?php } ?>
				<tr>
					...
					<td><strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['physicianTotal']->value, ENT_QUOTES, 'UTF-8');?>
<strong></td>
				</tr>
			</table>
		</div>
...
?>
	...
	<tr class="census" <?php if ($_smarty_tpl->tpl_vars['room']->value->datetime_discharge_bedhold_end!=''){?> bgcolor="yellow" <?php }elseif($_smarty_tpl->tpl_vars['room']->value->is_complete==0&&$_smarty_tpl->tpl_vars['room']->value->is_complete!=null&&$_smarty_tpl->tpl_vars['room']->value->datetime_discharge<$_smarty_tpl->tpl_vars['datetime']->value){?> bgcolor="#A65878"  <?php }elseif($_smarty_tpl->tpl_vars['room']->value->datetime_discharge!=''){?> bgcolor="#FF6A6A" <?php }elseif($_smarty_tpl->tpl_vars['occupant']->value==false){?> bgcolor="#FFA1A1" <?php }elseif($_smarty_tpl->tpl_vars['room']->value->transfer_request){?> bgcolor="orange" <?php }else{ ?>bgcolor="<?php echo smarty_function_cycle(array('values'=>"#d0e2f0,#ffffff"),$_smarty_tpl);?>
" <?php }?>>
		...
		<?php if ($_smarty_tpl->tpl_vars['occupant']->value!=false){?>
			...
			<?php if ($_smarty_tpl->tpl_vars['room']->value->status=='Under Consideration'){?>
				<td style="text-align: left;" class="text-blue"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['occupant']->value->fullName(), ENT_QUOTES, 'UTF-8');?>
</td>
			<?php }else{ ?>
...
<div class="background-orange">There has been a request to transfer to a different AHC facility.</div><?php }} ?>