<?php /* Smarty version Smarty-3.1.13, created on 2014-03-26 09:12:35
         compiled from "/var/www/admit_app/admissions/protected/tpl/coord/room.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2603205095332ee63650791-01609087%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c87fe1570e398a679ca2cd41b3ea9c567aac9334' => 
    array (
      0 => '/var/www/admit_app/admissions/protected/tpl/coord/room.tpl',
      1 => 1395702646,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2603205095332ee63650791-01609087',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5332ee637cb7e8_14600451',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5332ee637cb7e8_14600451')) {function content_5332ee637cb7e8_14600451($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/admit_app/cms2/protected/lib/contrib/Smarty-3.1.13/libs/plugins/modifier.date_format.php';
...
<!--
	<div class="sort-left">
		<strong><?php if ($_smarty_tpl->tpl_vars['goToApprove']->value==1){?>Admission<?php }else{ ?> Room Tranfer<?php }?> Date &amp; Time</strong> <input type="text" id="schedule-datetime" name="datetime_admit" value="<?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['datetime']->value,"%m/%d/%Y %I:%M %P"), ENT_QUOTES, 'UTF-8');?>
" />
	</div>
...
-->
	<table id="room-table" cellpadding="5" cellspacing="0">
		<tr>	
			<td colspan="4"><strong><?php if ($_smarty_tpl->tpl_vars['goToApprove']->value==1){?>Admission<?php }else{ ?> Room Tranfer<?php }?> Date &amp; Time</strong> <input type="text" id="schedule-datetime" name="datetime_admit" value="<?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['datetime']->value,"%m/%d/%Y %I:%M %P"), ENT_QUOTES, 'UTF-8');?>
" /></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
