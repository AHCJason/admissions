<?php /* Smarty version Smarty-3.1.13, created on 2014-03-26 10:25:19
         compiled from "/var/www/admit_app/admissions/protected/tpl/patient/notes.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20922233705332ff6f412600-92012906%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a380c6835b8fe7835127b4e3a9041d693943b1f8' => 
    array (
      0 => '/var/www/admit_app/admissions/protected/tpl/patient/notes.tpl',
      1 => 1395702646,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20922233705332ff6f412600-92012906',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5332ff6f5057f6_41922550',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5332ff6f5057f6_41922550')) {function content_5332ff6f5057f6_41922550($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/var/www/admit_app/cms2/protected/lib/contrib/Smarty-3.1.13/libs/plugins/function.cycle.php';
...
/?page=patient&amp;action=viewNotesFile&amp;schedule=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['schedule']->value->pubid, ENT_QUOTES, 'UTF-8');?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
			...
			<?php if ($_smarty_tpl->tpl_vars['patient']->value->notesAreConverted($_smarty_tpl->tpl_vars['i']->value)){?>
			<td width="20"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['SITE_URL']->value, ENT_QUOTES, 'UTF-8');?>
/?page=patient&amp;action=viewNotesFile&amp;schedule=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['schedule']->value->pubid, ENT_QUOTES, 'UTF-8');?>
&amp;idx=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['i']->value, ENT_QUOTES, 'UTF-8');?>
" title="View File"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ENGINE_URL']->value, ENT_QUOTES, 'UTF-8');?>
/images/icons/magnifier.png" alt="View File" /></a></td>
			<td width="20"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['SITE_URL']->value, ENT_QUOTES, 'UTF-8');?>
